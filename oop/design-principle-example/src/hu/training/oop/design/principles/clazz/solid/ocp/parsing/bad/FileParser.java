package hu.training.oop.design.principles.clazz.solid.ocp.parsing.bad;
 ...
 * 
 * In future, if there is a need to extend it for CSV Parsing, then you need to
 * implement new method parseCSV() and change parse() to add conditional logic.
 * That means, more efforts to spend on code review and testing.
 * 
...
public class FileParser {
	...
	public String parse(String filePath, String expression) {
		...
		} // ------- Add further conditional logic, if needs to support more
			// type such as CSV parsing
		return null;
	}
