...
public class ClientTestProgram {
	...
	public static void main(String[] args) {
		...
		// Why we got unexpected behavior in client? --- Because LSP is violated
		// in WinampMediaPlayer.java, as it changed the original behavior of
		// super class MediaPlayer.java
		playVideoInAllMediaPlayers(allPlayers);
	}
