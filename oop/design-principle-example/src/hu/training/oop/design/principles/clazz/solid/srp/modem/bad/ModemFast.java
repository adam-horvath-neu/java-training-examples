...
/**
 * Implementation class of modem interface for "fast mode" of data send and
 * receive. This is for design demo, so actual logic is not implemented
 * 
...
public class ModemFast implements IModem {
	 ...
	 * 
	 * @see
	 * hu.training.oop.design.principles.clazz.solid.srp.modem.bad.
	 * IModem#dial(java.lang.String)
	 */
	@Override
