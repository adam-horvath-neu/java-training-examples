...
/**
 * Milk is-a type of condiment, which is example of the concrete decorator
 * class.
 *
...
public class Milk extends CondimentDecorator {
	...
	// First delegate to the object we are decorating get its description, and
	// then append description for this condiment
