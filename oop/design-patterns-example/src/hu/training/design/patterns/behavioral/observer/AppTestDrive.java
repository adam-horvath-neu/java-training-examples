package hu.training.design.patterns.behavioral.observer;

import java.util.InputMismatchException;
import java.util.Scanner;

/**
 * Demo client which registers and unregister bidders (observers) with auctioner
 * (subject) participate in the auction. If we see, client app is not
 * responsible to broadcast updates to all registered observers, rather it is
 * accomplished through observer pattern.
 *
