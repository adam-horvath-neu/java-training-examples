...
/**
 * Example code snippet of Logger class singleton pattern implementation for
...
public class LoggerUsingLazyInstantiationDoubleLocking implements Serializable {
	...
	/*
	 * The singleton instance is created when the getInstance() method is called
	 * for the first time. This is called lazy instantiation and it ensures that
	 * the singleton instance is created only when it is needed.
	 */
	...
	/*
	 * When Singletons are implementing Serializable interface they have to
	 * implement readResolve method in order to avoid having 2 different
	 * objects. This method is called immediately after an object of this class
	 * is deserialized. This method returns the singleton instance.
	 */
